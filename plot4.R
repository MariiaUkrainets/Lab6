...
par(mfrow = c(2, 2))
# subplot 1
plot(new_df$Time, new_df$Global_active_power, type = 'l', xlab = '', ylab = 'Global Active Power')
# subplot 2
plot(new_df$Time, new_df$Voltage, type = 'l', xlab = 'datetime', ylab = 'Voltage')
# subplot 3
...
# subplot 4
plot(new_df$Time, new_df$Global_reactive_power, type = 'l', xlab = 'datetime', ylab = 'Global Rective Power')
dev.off()
